...
// src/main.cpp
//
// This is the main file which declares functions for initialising and managing ROS 2 nodes 
// for a robot control system. It includes functions to set up nodes for laser scan 
// processing, odometry processing, obstacle avoidance, and color detection, and 
// integrates these nodes into a multi-threaded executor for concurrent processing.
//
